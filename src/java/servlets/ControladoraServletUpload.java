        ...
        */
        ...
        try {
            ...
            */
            ...
            //refazer writer.println("New file " + fileName + " created at " + path);
            //refazer LOGGER.log(Level.INFO, "File{0} being uploaded to {1}", new Object[]{fileName, path});
            ...
            u.setTipo(tipo);
            //refazer Facade.perfilFoto(u, fileName);
            if("V".equals(tipo)){
            ...
            //refazerLOGGER.log(Level.SEVERE, "Problems during file upload. Error: {0}", new Object[]{fne.getMessage()});
        } finally {
            if (out != null) {
                out.close();
            }
