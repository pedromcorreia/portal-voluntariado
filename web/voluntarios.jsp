...
<html>
    <head>
        <title>Voluntarius - voluntarios</title>
          ...
          <div class="col-md-12">
            <div class="cover profile">
              ...
              <div class="cover-info">
                <div class="avatar">
                  ...
                  <c:choose>
                    <c:when test="${instituicao.foto != null}"> 
                      <img src="images/Friends/<c:out value="${instituicao.foto}"/>" alt="people">
                    </c:when>
                    <c:otherwise>
                ...
                <div class="name"><a href="#"><c:out value="${instituicao.nome}"/></a></div>
                <ul class="cover-nav">
                  <li><a href="profile.html"><i class="fa fa-fw fa-bars"></i> Timeline</a></li>
                  <li><a href="ControladoraServlet?action=perfilInstituicao"><i class="fa fa-fw fa-user"></i>Perfil Institucional</a></li>
                  <li class="active"><a href="#"><i class="fa fa-fw fa-users"></i> Voluntarios</a></li>
        ...
        <div class="row">
          ...
          <div class="col-md-3">
              <div class="contact-box center-version">
                <a href="ControladoraServlet?action=perfilVoluntario&perfil=<c:out value="${voluntario.usuario}" />">
                  
                  <c:choose>
                  <c:when test="${voluntario.foto!=null}">    
                    <img alt="image" class="img-circle" src="images/Friends/<c:out value="${voluntario.foto}" />" >
                  </c:when>
                  <c:otherwise>
                  ...
                  <h3 class="m-b-xs"><strong><c:out value="${voluntario.nome}" /></strong></h3>
                ...
                <div class="contact-box-footer">
                  <div class="m-t-xs btn-group">
                    ...
                    <a class="btn btn-xs btn-white"><i class="fa fa-user-times"></i>Excluir Voluntário</a>
                  </div>
                </div>
              </div>
          </div>
