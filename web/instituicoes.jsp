    ...
    <div class="row page-content">
      <div class="col-md-8 col-md-offset-2">
            ...
            <div class="cover profile">
              ...
              <div class="cover-info">
                ...
                <ul class="cover-nav">
                  ...
                  <li class="active"><a href="#"><i class="fa fa-fw fa-users"></i> Instituições</a></li>
        ...
        <div class="row">
          ...
          <c:forEach var="ins" items="${instituicoes}">
          <div class="col-md-3">
              <div class="contact-box center-version">
                <a href="ControladoraServlet?action=perfilInstituicao&perfil=<c:out value="${ins.usuario}" />">
                  
                  <c:choose>
                  <c:when test="${ins.foto!=null}">    
                    <img alt="image" class="img-circle" src="images/Friends/<c:out value="${ins.foto}" />" >
                  </c:when>
                  <c:otherwise>
                  ...
                  <h3 class="m-b-xs"><strong><c:out value="${ins.nome}" /></strong></h3>
                ...
                <div class="contact-box-footer">
                  <div class="m-t-xs btn-group">
                    ...
                    <a class="btn btn-xs btn-white"><i class="fa fa-user-times"></i> Deixar de Seguir</a>
                  </div>
                </div>
              </div>
          </div>
